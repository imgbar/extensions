...
zip.writeZip(`${__dirname}/built/imgbar_${extension}_${version}.zip`)
console.log(`Done: built/imgbar_${extension}_${version}.zip`)

if (isWatching) {
  zip.extractAllTo(`${__dirname}/built/`, true)
  console.log(`Done: Extracted built/imgbar_${extension}_${version}.zip`)
}
